...
import io.mosip.print.constant.APIAuthorityList;
import io.mosip.print.constant.LoggerFileConstant;
import io.mosip.print.dto.TokenResponseDTO;
...
public class TokenValidator {
	/** The reg proc logger. */
	private static Logger regProcLogger = PrintLogger.getLogger(TokenValidator.class);
