...
import io.mosip.print.dto.PrintRequest;
import io.mosip.print.dto.RequestDTO;
...
public class PrintServiceRequestValidator implements Validator {
	...
	private static final String DATETIME_TIMEZONE = "mosip.print.timezone";

	/** The Constant DATETIME_PATTERN. */
	private static final String DATETIME_PATTERN = "mosip.print.datetime.pattern";

	/** The mosip logger. */
	Logger regProcLogger = PrintLogger.getLogger(PrintServiceRequestValidator.class);
